  ...
  return (
    <div className="flex items-center justify-between gap-3">
      <div className="flex items-stretch gap-3 min-w-0">
        <div
          className="aspect-square self-stretch rounded-[11px] overflow-hidden shrink-0"
          style={{ background: 'var(--nanny-purple)' }}
        >
          <Image src="/icon-192.png" alt="Nanny" width={96} height={96} className="h-full w-full object-cover" />
        </div>
